...
public class Doctor {
	...
	public String insertDoctors(String dname, String dtype, String contact, String address, String email,
		...
		try {
			...
			if (con == null) {
				return "Error while connecting to the util for inserting....";
			}
...
//execute the statement
	...
	public String readDoctors() {
		...
		try {
			Connection con = obj.connect();
			if (con == null) {
				return "Error while connecting to the util for reading.";
			}
	...
	public String updateDoctors(String ID, String dname, String dtype, String contact, String address, String email,
		...
		try {
			Connection con = obj.connect();
			if (con == null) {
				return "Error while connecting to the util for updating....";
			}
	...
	public String deleteDoctor(String Doctor_ID) {
		...
		try {
			Connection con = obj.connect();
			if (con == null) {
				return "Error while connecting to the util for deleting.";
			}
